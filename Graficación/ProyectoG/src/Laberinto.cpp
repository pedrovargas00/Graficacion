...
Laberinto::Laberinto(){
    ...
    tamXZ = 19; tammenosXZ = 23; tammenosXmenosZ = 22;  tamXmenosZ = 23;
}
...
void Laberinto::draw(){
    ...
    cubo[14].trasladar(0, 0, -7);
    cubo[14].escalar(1, 2, 1);
    cubo[15].trasladar(-5, 0, 4);
    cubo[15].escalar(4, 2, 1);
    cubo[16].trasladar(0, 0, 4);
    cubo[16].escalar(6, 2, 1);
    ...
    cubo[27].trasladar(-10, 0, -7);
    cubo[27].escalar(4, 2, 1);
    ...
    cubo[32].trasladar(-10, 0, 8);
    cubo[32].escalar(8, 2, 1);
    ...
    cubo[61].trasladar(-6, 0, 5);
    cubo[61].escalar(3,2,1);
    cubo[61].rotar(90,0,1,0);
    ...
    for(int i = 0; i < 84; i++)
        cubo[i].draw();
    if(bonos[0].getTocado())
        bonos[0].trasladar(20, -1.4, 20);
    else{
        bonos[0].trasladar(-12.5, 0.4, 9.5);
        bonos[0].draw();
    }
    if(bonos[1].getTocado())
        bonos[1].trasladar(20, -1.4, 20);
    else{
        bonos[1].trasladar(5, 0.4, -11.5);
        bonos[1].rotar(90,0,1,0);
        bonos[1].draw();
    }
    if(bonos[2].getTocado())
        bonos[2].trasladar(20, -1.4, 20);
    else{
        bonos[2].trasladar(13.5, 0.4, -3);
        bonos[2].draw();
    }
...
void Laberinto::setmenosXmenosZ(){
    ...
    menosXmenosZ[11] = cubo[33];
    menosXmenosZ[12] = cubo[39];
    menosXmenosZ[13] = cubo[40];
    menosXmenosZ[14] = cubo[41];
    menosXmenosZ[15] = cubo[49];
    menosXmenosZ[16] = cubo[77];
    menosXmenosZ[17] = cubo[48];
    menosXmenosZ[18] = cubo[78];
    menosXmenosZ[19] = cubo[80];
    menosXmenosZ[20] = cubo[83];
    menosXmenosZ[21] = cubo[27];
}
...
bool Laberinto::verificarCoordenadasBono(float x, float z){

    return c.verificarColisionBonos(x, z, bonos);
}

bool Laberinto::verificarColisionCopa(float x, float z){
...
bool Laberinto::verificarCoordenadasDementor(float x, float z){

    printf("\nRecibe: %f, %f", x, z);
    if((x > 0 && z > 0) || (x == 0 && z > 0)){
            printf("\nEntra XZ-> X : %f Z: %f \n", x, z);
            setXZ();
        return c.verificarColisionDementor(x, z, tamXZ, XZ);
    }if((x < 0 && z > 0) || (x < 0 && z == 0)){
            printf("\nEntra menosXZ-> X : %f Z: %f \n", x, z);
            setmenosXZ();
        return c.verificarColisionDementor(x, z, tammenosXZ, menosXZ);
    }if((x > 0 && z < 0) || (x > 0 && z == 0)){
            printf("\nEntra XmenosZ-> X : %f Z: %f \n", x, z);
            setXmenosZ();
         return c.verificarColisionDementor(x, z, tamXmenosZ, XmenosZ);
    }if((x < 0 && z < 0) || (x == 0 && z < 0)){
            printf("\nEntra menosXmenosZ-> X : %f Z: %f \n", x, z);
            setmenosXmenosZ();
        return c.verificarColisionDementor(x, z, tammenosXmenosZ, menosXmenosZ);
    }

}

Bonos* Laberinto::getBonos(){
