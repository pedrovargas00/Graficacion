...
void Cubo::draw1(){
    ...
    dib1 = textura.loadImage("C:/Users/Pedro/Desktop/Graficación/ProyectoGraf/loza.jpg");
...
void Cubo::dragon(){
    ...
    dib1 = textura.loadImage("C:/Users/Pedro/Desktop/Graficación/ProyectoGraf/dragon.jpg");
    texturas = textura.loadTexture(dib1);
    FreeImage_Unload(dib1);
